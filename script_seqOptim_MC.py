...
FA_list=[FA_list[0]]+[np.unique(FA_list[1:])[1]]*(len(FA_list)-1)

new_sequence_file=str.split(sequence_file,".json")[0]+"_flat_FA_{}.json".format(np.round(min_TR_delay,2))

generate_epg_dico_T1MRFSS_NoInv(new_sequence_file,"mrf_dictconf_Dico2_Invivo_lightT1.json",FA_list,TE_list,reco,min_TR_delay/1000)
#

generate_epg_dico_T1MRFSS_NoInv(new_sequence_file,"mrf_dictconf_Dico2_Invivo_light_for_matching.json",FA_list,TE_list,reco,min_TR_delay/1000)
