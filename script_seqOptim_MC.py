...
lambda_T1=1
inversion=True
res=differential_evolution(cost_function_simul_breaks_common,bounds=bounds,constraints=constraints)
...
plt.plot(TE_[1:])
res.x
generate_epg_dico_T1MRFSS(r"./mrf_sequence_adjusted_optimized_M0_T1_local_optim_correl_crlb_filter_sp1400_optimized_DE_Simu_FF_v6.json","./mrf_dictconf_SimReco2_lightDFB1.json",FA_,TE_,0,1.87/1000,fileseq_basis="./mrf_sequence_adjusted.json")
