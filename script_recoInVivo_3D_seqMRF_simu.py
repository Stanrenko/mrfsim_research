...
dictfile="mrf_dictconf_SimReco2_light_adjusted_optimized_M0_T1_local_optim_correl_crlb_filter_sp760_optimized_DE_Simu_FF_v2_reco3.dict"
suffix="_DE_Simu_FF_v2_reco3"
with open("./mrf_sequence_adjusted_optimized_M0_T1_local_optim_correl_crlb_filter_sp760_optimized_DE_Simu_FF_v2.json") as f:
    sequence_config = json.load(f)

# dictfile="mrf175_SimReco2_light_adjusted.dict"
# suffix="_fullReco_Brute"
# with open("./mrf_sequence_adjusted.json") as f:
#     sequence_config = json.load(f)
...
for suffix in ["fullReco_T1MRF_adjusted","fullReco_Brute","DE_Simu_FF_reco3","DE_Simu_FF_v2_reco3"]:
