...
filename_categories_global = folder +"/categories_global.npy"
filename_df_groups_global= folder+"/df_groups_global.pkl"
...
filename_kdata_final = folder +"/kdata_final.npy"
