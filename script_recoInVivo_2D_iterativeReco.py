...
for j in range(niter):
    regression_paramMaps_ROI(m_.paramMap,all_maps_cf[0][0],mask>0,all_maps_cf[0][1]>0,maskROI,adj_wT1=False,title="iter{}_CF_regROI_".format(j)+str.split(str.split(filename_volume,"/")[-1],".npy")[0],save=True)
