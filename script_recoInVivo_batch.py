...
for p in patient_names:
    for exam_type in exam_types:
        ...
        for sl in range(1,maskROI.shape[0]-1):
            ...
            maskROI_current = maskROI[sl,:,:][all_maps_python_current_slice[1]>0]
            ...
            try:
                ...
                regression_paramMaps_ROI(all_maps_python_current_slice[0],all_maps_matlab_current_slice[0],all_maps_python_current_slice[1]>0,all_maps_matlab_current_slice[1]>0,maskROI=maskROI_current,save=True,title="{} {}: Python vs Matlab Invivo slice {}".format(p,exam_type,sl),kept_keys=["attB1","df","wT1","ff"],adj_wT1=True,fat_threshold=0.7)
            except:
