...
python scripts/script_recoInVivo_3D_machines.py generate_dixon_volumes_for_segmentation --filemap $1_bart12_volumes_singular_denoised_CF_iterative_2Dplus1_MRF_map.pkl
...
python scripts/script_recoInVivo_3D_machines.py generate_mask_roi_from_segmentation --fileseg $1_bart12_volumes_singular_denoised_ip.nii.gz

echo "######################################################"
echo "Calculating ROI results"
python scripts/script_recoInVivo_3D_machines.py getROIresults --filemap $1_bart12_volumes_singular_denoised_CF_iterative_2Dplus1_MRF_map.pkl --fileroi $1_bart12_volumes_singular_denoised_ip_maskROI.npy --filelabels ${filepath}/labels.txt --excluded 10 --kernel 5 --roi 100
