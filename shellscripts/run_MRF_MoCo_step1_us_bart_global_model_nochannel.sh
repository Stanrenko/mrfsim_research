...
python script_recoInVivo_3D_machines.py coil_compression_bart --filename-kdata ${1}_kdata.npy --n-comp $NCOMP #--filename-cc $1_bart_cc.cfl
cp ${1}_bart${NCOMP}_b12Dplus1_${NCOMP}.jpg /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
