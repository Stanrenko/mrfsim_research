...
# $2 : Full MRF dictionary e.g. mrf_dict_optim/dico_TR2.18_reco2.99.pkl
# $3 : Nb segments (optional - default 1024)
# $4 : Example slice 1 (optional - default 80)
