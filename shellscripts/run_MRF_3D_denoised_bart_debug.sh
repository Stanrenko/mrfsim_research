...
# python script_recoInVivo_3D_machines.py build_volumes_singular --filename-kdata $1_bart${NCOMP}_kdata.npy --n-comp $NCOMP --L0 $NSING --dictfile ${DICTFILE_LOWBODY} --useGPU False --filename-seqParams $1_seqParams.pkl
# # rm $1_kdata.npy
