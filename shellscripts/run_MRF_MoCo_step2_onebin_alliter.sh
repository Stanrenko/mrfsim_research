...
python script_recoInVivo_3D_machines.py build_volumes_iterative_allbins_registered --index-ref 0 --filename-volume $1_volumes_singular_allbins.npy --filename-b1 $1_b12Dplus1_$NCOMP.npy --niter $NITER --file-deformation $2_volumes_allbins_registered_allindex_deformation_map.npy --filename-weights $1_weights.npy --lambda-wav 1e-5 --use-wavelet True --mu 2 --gating-only True 
...
do
    python script_recoInVivo_3D_machines.py build_mask_from_singular_volume --filename-volume $1_volumes_singular_allbins.npy_volumes_allbins_registered_ref0_it${i}.npy --l 0 --threshold 0.04 --it 2
done
...
do
    ...
    python script_recoInVivo_3D_machines.py build_maps --filename-volume "$1_volumes_singular_allbins.npy_volumes_allbins_registered_ref0_it${i}.npy" --filename-mask "$1_volumes_singular_allbins_volumes_allbins_registered_ref0_it${i}_l0_mask.npy" --filename-b1 $1_b12Dplus1_${NCOMP}.npy --dictfile $3 --dictfile-light $4 --optimizer-config opt_config_iterative_singular_shell.json --filename $1.dat #--slices "80"
done
