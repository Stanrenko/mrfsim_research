...
python script_recoInVivo_3D_machines.py build_volumes_singular --filename-kdata $1_kdata.npy --n-comp $NCOMP --L0 $NSING --dictfile $2 --useGPU False --filename-weights $1_us_weights.npy
rm $1_kdata.npy
...
#python script_recoInVivo_3D_machines.py build_volumes_iterative --filename-volume $1_volumes_singular.npy  --niter $NITER  --filename-weights $1_us_weights.npy --use-wavelet True --lambda-wav 1e-5 --mu 0.1 --filename-b1 $1_b12Dplus1_${NCOMP}.npy #--filename-b1 data/InVivo/3D/patient.003.v19/meas_MID00088_FID70345_raFin_3D_tra_0_8x0_8x3mm_FULL_new_mrf_us2_b12Dplus1_12.npy
