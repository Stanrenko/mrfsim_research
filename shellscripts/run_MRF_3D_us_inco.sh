...
python script_recoInVivo_3D_machines.py build_volumes_iterative --filename-volume $1_volumes_singular.npy  --niter $NITER  --use-wavelet True --lambda-wav 1e-6 --mu 1 --filename-b1 $1_b1.npy --filename-seqParams $1_seqParams.pkl #--filename-b1 data/InVivo/3D/patient.003.v19/meas_MID00088_FID70345_raFin_3D_tra_0_8x0_8x3mm_FULL_new_mrf_us2_b12Dplus1_12.npy
...
python script_recoInVivo_3D_machines.py build_maps --filename-volume "$1_volumes_singular_denoised.npy" --filename-mask "$1_volumes_singular_denoised_l0_mask.npy" --filename-b1 $1_b1.npy --dictfile $2 --dictfile-light $3 --optimizer-config opt_config_iterative_singular_shell.json --filename $1.dat
