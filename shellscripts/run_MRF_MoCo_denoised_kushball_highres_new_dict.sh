...
# python scripts/script_recoInVivo_3D_machines.py build_navigator_images --filename-nav-save $1_nav.npy --seasonal-adj True
...
# python scripts/script_recoInVivo_3D_machines.py calculate_displacement_weights_new --filename-nav-save $1_nav.npy --incoherent False --nb-segments ${NSEGMENTS} --ntimesteps 1 --equal-spoke-per-bin True --ch $CHANNEL --nbins $NBINS --retained-categories "0,1,2,3,4" --sim-us $SIMUS --us $US --pad 0 --nspoke-per-z 1 --hard-interp True #--soft-weight True #--stddisp 1.5
...
# python scripts/script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}.npy --file-config-train config/config_train_voxelmorph_highres_shell_test.json --nepochs 3000 --kept-bins "0,1,2,3,4" --excluded 20 --us 2 #--lr 0.0002 --init-weights $1_volumes_allbins_denoised_gamma_0_8_vxm_model_weights.h5
...
python scripts/script_VoxelMorph_machines.py train_voxelmorph_3D --filename-volumes $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}.npy --file-config-train config/config_train_voxelmorph_3D_anisotropic.json --nepochs 3000 --kept-bins "0,1,2,3,4" --downsample 2 #--lr 0.0002 --init-weights $1_volumes_allbins_denoised_gamma_0_8_vxm_model_weights.h5
python scripts/script_VoxelMorph_machines.py register_allbins_to_baseline_3D --filename-volumes $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}.npy --file-model $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}_vxm_model_weights_3D.h5 --file-config-train config/config_train_voxelmorph_3D_anisotropic.json --downsample 2
# python scripts/script_VoxelMorph_machines.py register_allbins_to_baseline_3D --filename-volumes $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}.npy --file-model data/InVivo/3D/processing_2/model_checkpoint_3D.h5 --file-config-train config/config_train_voxelmorph_3D.json 


python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}_registered_3D.npy --sl ${SLICE1}
cp $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}_registered_3D.npy_sl${SLICE1}_moving_singular.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}_registered_3D.npy --sl ${SLICE2}
cp $1_bart${NCOMP}_volume_singular_l0_allbins_gamma_${GAMMASTR}_registered_3D.npy_sl${SLICE2}_moving_singular.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
...
# python scripts/script_recoInVivo_3D_machines.py build_mask_from_singular_volume --filename-volume $1_bart${NCOMP}_volumes_singular_allbins.npy_volumes_allbins_registered_${VOLUMESSUFFIX}.npy --l 0 --threshold 0.015 --it 1
