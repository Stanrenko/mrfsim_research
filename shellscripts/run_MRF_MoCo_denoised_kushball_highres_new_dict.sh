...
# python scripts/script_recoInVivo_3D_machines.py build_kdata --filename $1.dat --index ${INDEX} --dens-adj False #--nb-rep 40 #--dens-adj False
...
# python scripts/script_recoInVivo_3D_machines.py coil_compression_bart --filename-kdata $1_no_densadj_kdata.npy --n-comp $NCOMP --spoke-start 400 --filename-seqParams $1_seqParams.pkl --lowmem True # --dens-adj False
# # exit
...
# python scripts/script_recoInVivo_3D_machines.py build_volumes_singular_allbins_3D_BART_bmy --filename-kdata $1_no_densadj_bart${NCOMP}_kdata.npy --filename-seqParams $1_seqParams.pkl --L0 $NSING --dictfile $2 --useGPU False --filename-b1 $1_no_densadj_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --filename-weights $1_weights.npy --gating-only True --dens-adj True --gamma $GAMMA
# python scripts/script_recoInVivo_3D_machines.py build_volumes_singular_allbins_3D_BART_bmy2 --filename-kdata $1_no_densadj_bart${NCOMP}_kdata.npy --filename-seqParams $1_seqParams.pkl --L0 $NSING --dictfile $2 --useGPU False --filename-b1 $1_no_densadj_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --filename-weights $1_weights.npy --gating-only True --dens-adj True --gamma $GAMMA --filename-bart-opts ../config/config_BART_reg_xyz.json
# python scripts/script_recoInVivo_3D_machines.py correct_intensity --filename-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy --gamma $GAMMA
# rm $1_bart${NCOMP}_kdata.npy

# python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart_gamma_${GAMMA}.npy --sl ${SLICE1} --l 0
# cp $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart_gamma_${GAMMA}.npy_sl${SLICE1}_moving_singular.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
# python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart_gamma_${GAMMA}.npy --sl ${SLICE2} --l 0
# cp $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart_gamma_${GAMMA}.npy_sl${SLICE2}_moving_singular.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
...
# python scripts/script_recoInVivo_3D_machines.py extract_singular_volume_allbins --file-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy --l 0
...
python scripts/script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart.npy --file-config-train ../config/config_train_voxelmorph_highres_shell.json --nepochs 1500 --kept-bins "0,1,2,3,4" --excluded 10 --us 4 #--lr 0.0002 --init-weights $1_volumes_allbins_denoised_gamma_0_8_vxm_model_weights.h5
# python scripts/script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart.npy --file-model $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart_vxm_model_weights.h5 --file-config-train ../config/config_train_voxelmorph_highres_shell.json --axis 0

# python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart_registered.npy --sl ${SLICE1}
# cp $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart_registered.npy_sl${SLICE1}_moving_singular.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
# python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart_registered.npy --sl ${SLICE2}
# cp $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart_registered.npy_sl${SLICE2}_moving_singular.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo

# NITER=0

# python scripts/script_recoInVivo_3D_machines.py build_volumes_iterative_allbins_registered_allindex --filename-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy --filename-b1 $1_no_densadj_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --niter 0 --file-deformation $1_no_densadj_bart${NCOMP}_volume_singular_l0_allbins_bart_deformation_map.npy --filename-weights $1_weights.npy --axis 0 --filename-seqParams $1_seqParams.pkl #--us 2

# python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy_volumes_allbins_registered_allindex.npy --sl ${SLICE1}
# cp $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy_volumes_allbins_registered_allindex.npy_sl${SLICE1}_moving_singular_l0.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
# python scripts/script_recoInVivo_3D_machines.py generate_movement_gif --file-volume $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy_volumes_allbins_registered_allindex.npy --sl ${SLICE2}
# cp $1_no_densadj_bart${NCOMP}_volumes_singular_allbins_bart.npy_volumes_allbins_registered_allindex.npy_sl${SLICE2}_moving_singular_l0.gif /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/log_MRF_MoCo
