...
museg-ai inter $1_volumes_singular_ip.mha $1_volumes_singular_oop.mha
conda deactivate

echo ${filename}_volumes_singular_ip.nii.gz
mv ${currpath}/${filename}_volumes_singular_ip.nii.gz ${filepath}/${filename}_volumes_singular_ip.nii.gz
...
python script_recoInVivo_3D_machines.py getROIresults --filemap $1_volumes_singular_CF_iterative_2Dplus1_MRF_map.pkl --fileroi $1_volumes_singular_ip_maskROI.npy
