...
python script_recoInVivo_3D_machines.py build_volumes_iterative_allbins --filename-volume $1_bart${NCOMP}_volumes_allbins.npy --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --mu-TV 0.1 --mu-bins 0. --gamma $GAMMA --niter 5 --filename-weights $1_weights.npy --axis 1
...
python script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_bart${NCOMP}_volumes_allbins_denoised_gamma_${GAMMASTR}.npy --config-train config_train_voxelmorph_shell.json --nepochs 1500 --kept-bins "0,1,2,3" --axis 1 #--lr 0.0002 --init-weights $1_volumes_allbins_denoised_gamma_0_8_vxm_model_weights.h5
python script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_bart${NCOMP}_volumes_allbins_denoised_gamma_${GAMMASTR}.npy --file-model $1_bart${NCOMP}_volumes_allbins_denoised_gamma_${GAMMASTR}_vxm_model_weights.h5 --config-train config_train_voxelmorph_shell.json --axis 1
...
python  script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_bart${NCOMP}_volumes_allbins_registered_allindex.npy --config-train config_train_voxelmorph_shell.json --nepochs 1500 --kept-bins "0,1,2,3" --axis 1

python script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_bart${NCOMP}_volumes_allbins_registered_allindex.npy --file-model $1_bart${NCOMP}_volumes_allbins_registered_allindex_vxm_model_weights.h5 --config-train config_train_voxelmorph_shell.json --axis 1
