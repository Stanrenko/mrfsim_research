...
#python script_recoInVivo_3D_machines.py build_volumes_singular_allbins --filename-kdata $1_bart${NCOMP}_kdata.npy --L0 $NSING --dictfile $2 --gating-only True --useGPU False --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --filename-pca $1_bart${NCOMP}_virtualcoils_${NCOMP}.pkl --filename-weights $1_weights.npy
...
#python script_recoInVivo_3D_machines.py build_volumes_singular_allbins_3D --filename-kdata $1_bart${NCOMP}_kdata.npy --L0 $NSING --dictfile $2 --useGPU False --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --filename-weights $1_weights.npy --gating-only True 
...
#python script_recoInVivo_3D_machines.py build_volumes_iterative_allbins_registered --index-ref ${REF} --filename-volume $1_bart${NCOMP}_volumes_singular_allbins.npy  --niter ${NITER} --filename-weights $1_weights.npy --lambda-wav 1e-6 --use-wavelet False --mu 1 --gating-only False --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy #--filename-b1 data/InVivo/3D/patient.003.v19/meas_MID00088_FID70345_raFin_3D_tra_0_8x0_8x3mm_FULL_new_mrf_us2_b12Dplus1_12.npy
python script_recoInVivo_3D_machines.py build_volumes_iterative_allbins_registered --index-ref ${REF} --filename-volume $1_bart${NCOMP}_volumes_singular_allbins.npy  --niter ${NITER} --filename-weights $1_weights.npy --lambda-wav 1e-6 --mu 1 --gating-only True --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy #--filename-b1 data/InVivo/3D/patient.003.v19/meas_MID00088_FID70345_raFin_3D_tra_0_8x0_8x3mm_FULL_new_mrf_us2_b12Dplus1_12.npy
