...
python script_recoInVivo_3D_machines.py generate_dixon_volumes_for_segmentation --filemap $1_volumes_singular_denoised_CF_iterative_2Dplus1_MRF_map.pkl
...
conda activate mutools-dev
museg-ai inter $1_volumes_singular_denoised_ip.mha $1_volumes_singular_denoised_oop.mha
conda deactivate
...
python script_recoInVivo_3D_machines.py generate_mask_roi_from_segmentation --fileseg $1_volumes_singular_denoised_ip.nii.gz

echo "######################################################"
echo "Calculating ROI results"
python script_recoInVivo_3D_machines.py getROIresults --filemap $1_volumes_singular_denoised_CF_iterative_2Dplus1_MRF_map.pkl --fileroi $1_volumes_singular_denoised_ip_maskROI.npy
