...
python script_recoInVivo_3D_machines.py build_kdata --filename $1.dat --index ${INDEX} #--nb-rep 50
...
python script_recoInVivo_3D_machines.py build_volumes_singular --filename-kdata $1_bart${NCOMP}_kdata.npy --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --filename-seqParams $1_seqParams.pkl --filename-pca $1_bart${NCOMP}_virtualcoils_${NCOMP}.pkl --L0 $NSING --dictfile $2 --useGPU False
# rm $1_kdata.npy
...
python script_recoInVivo_3D_machines.py build_mask_from_singular_volume --filename-volume $1_bart${NCOMP}_volumes_singular_denoised.npy --l 0 --threshold 0.015 --it 1
