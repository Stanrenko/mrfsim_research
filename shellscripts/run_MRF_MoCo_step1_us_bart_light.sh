...
python  script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_bart${NCOMP}_volumes_allbins.npy --config-train config_train_voxelmorph_shell.json --nepochs 1000 --kept-bins "0,1,2,3" #--lr 0.0002 --init-weights $1_volumes_allbins_denoised_gamma_0_8_vxm_model_weights.h5
python script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_bart${NCOMP}_volumes_allbins.npy --file-model $1_bart${NCOMP}_volumes_allbins_vxm_model_weights.h5 --config-train config_train_voxelmorph_shell.json
