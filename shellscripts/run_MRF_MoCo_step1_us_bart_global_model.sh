...
# # # python script_recoInVivo_3D_machines.py build_volumes_iterative_allbins --filename-volume $1_bart${NCOMP}_volumes_allbins.npy --filename-b1 $1_bart${NCOMP}_b12Dplus1_${NCOMP}.npy --use-wavelet True --lambda-wav ${WAV} --mu 0.1 --mu-bins 0. --gamma $GAMMA --niter 2 --filename-weights $1_weights.npy
...
# python script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_bart${NCOMP}_volumes_allbins_denoised_gamma_${GAMMASTR}.npy --file-model /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/test_global_model/multiple_patients_vxm_model_weights_torchaugment.h5 --config-train config_train_voxelmorph.json
...
# # python script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_bart${NCOMP}_volumes_allbins.npy --file-model /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/test_global_model/multiple_patients_vxm_model_weights_torchaugment.h5 --config-train config_train_voxelmorph.json
...
python script_VoxelMorph_machines.py register_allbins_to_baseline --filename-volumes $1_bart${NCOMP}_volumes_allbins_registered_allindex.npy --file-model /mnt/rmn_files/0_Wip/New/1_Methodological_Developments/1_Methodologie_3T/#9_2021_MR_MyoMap/3_Data_Processed/test_global_model/multiple_patients_vxm_model_weights_torchaugment.h5 --config-train config_train_voxelmorph.json
