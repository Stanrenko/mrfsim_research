...
python script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_bart${NCOMP}_volumes_allbins_denoised_gamma_${GAMMASTR}.npy --config-train config_train_voxelmorph_shell.json --nepochs 2000 --kept-bins "1,2,3,4" #--lr 0.0002 --init-weights $1_volumes_allbins_denoised_gamma_0_8_vxm_model_weights.h5
...
python  script_VoxelMorph_machines.py train_voxelmorph --filename-volumes $1_bart${NCOMP}_volumes_allbins_registered_allindex.npy --config-train config_train_voxelmorph_shell.json --nepochs 1500 --kept-bins "1,2,3,4"
